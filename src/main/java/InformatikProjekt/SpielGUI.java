...
class SpielGUI implements Runnable {
    ...
    public Future<boolean[]> gebeSpielabsicht() {
    ...
    public void gebefarbeFuerSpielabsicht() {
        SwingUtilities.invokeLater(() -> {
            Future<boolean[]> futureGebeFarbeFuerSpielabsicht = executer.submit(() -> {
