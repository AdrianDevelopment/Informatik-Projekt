...
public class BotTest {
    ...
    */
    ...
    public void testKarteLegen() {
        ...
        bot.karteWurdeGelegt(new Spielkarte(Farbe.EICHEL, Werte.SAU), 1, 0);
        ...
        bot.karteWurdeGelegt(new Spielkarte(Farbe.EICHEL, Werte.SAU), 1, 0);
        bot.karteWurdeGelegt(new Spielkarte(Farbe.SCHELLEN, Werte.SIEBENER), 2, 0);
        bot.karteWurdeGelegt(new Spielkarte(Farbe.HERZ, Werte.ZEHNER), 3, 0);
